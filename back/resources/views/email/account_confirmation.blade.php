<html>
<body>
    <div style="height: 80px; width: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center; position: relative; overflow: hidden; background-color: #2196f3; color: white;">
        <div style="position: absolute; right: -20px; bottom: -40px; opacity: 0.2; overflow: hidden;">
            <svg viewBox="0 0 512 512" style="height: 125px; width: 125px;">
        ...
        <span style="text-align: center; font-size: 30px; font-weight: 400; z-index: 1;">Ludo Score</span>
    </div>
    <br/>
