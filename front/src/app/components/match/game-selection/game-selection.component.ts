...
export class GameSelectionComponent implements OnInit {
  ...
  public gameSelection(game: GameEntity) {
    this.loading = true
    this.store.dispatch(new CreateMatch(game.id, game.title, game.imageId, game.minPlayers, game.maxPlayers, game.matchTags, game.playerTags, game.playerColors)).subscribe((e) =>
      {
